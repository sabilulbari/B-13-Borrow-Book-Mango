  ...
  return (
    <div className="py-10 w-[90%] mx-auto space-y-5">
      ...
      <div className="grid grid-cols-10 gap-5">
        ...
        <div className="grid col-span-7 grid-cols-3 gap-8">
          {allBook
            .filter((b) => b.title.toLowerCase().includes(search.toLowerCase()))
            .filter((b) => selectedCategory === '' || b.category === selectedCategory)
            .map((b) => (
              <div key={b.id}>
                <div className="card  backdrop-blur-xl shadow-xl shadow-slate-900/20 border border-black/5 rounded-2xl p-2 hover:scale-102 transition-transform duration-300">
                  <div className="bg-white/10 flex items-center rounded-xl justify-center  ">
                    <Image className=" h-fit w-fit rounded-lg" src={b.image_url} width={150} height={200} alt="Book Cover" />
                  </div>
